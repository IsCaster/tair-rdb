 ...
 * statistics impl
 *
 * Version: $Id: stat_helper.cpp 587 2012-02-27 07:13:05Z yexiang $
 *
 * Authors:
...
namespace tair
{
    ...
    {
        log_info("start stat_helper thread");
    ...
    void stat_helper::do_compress()
    {
        ...
        int ret = compress(dest, &dest_len, (const unsigned char *)curr_stat, STAT_TOTAL_SIZE);
        if (ret == Z_OK)
        {
